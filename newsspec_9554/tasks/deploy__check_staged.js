module.exports = function (grunt) {
    grunt.registerTask('checkDeployedToStage', ['Checking content on stage'], function () {
        ...
        try {
          // Query the entry
            stats = fs.lstatSync(env.stage.mount + '/news/special/' + config.year + '/newsspec_' + config.parent_project_number + '/newsspec_' + config.project_number + '/content/' + config.services.default);
          // Is it a directory?
